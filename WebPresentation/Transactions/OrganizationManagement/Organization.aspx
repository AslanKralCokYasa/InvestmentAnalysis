<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/GMPMasterPage.master"
    AutoEventWireup="true" CodeFile="Organization.aspx.cs" Inherits="Transactions_OrganizationManagement_Organization" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="section">
        <div class="box">
            <div class="title">
                Organizasyon Listesi <span class="hide"></span>
            </div>
            <div runat="server" class="content" id="contentOrgList">
                <asp:GridView ID="organizationListGridView" runat="server" AutoGenerateColumns="False"
                    CellPadding="0" BorderStyle="None" BorderWidth="0px" DataKeyNames="ID" OnRowCancelingEdit="organizationListGridView_RowCancelingEdit"
                    OnRowDeleting="organizationListGridView_RowDeleting" OnRowEditing="organizationListGridView_RowEditing"
                    OnRowUpdating="organizationListGridView_RowUpdating">
                    <Columns>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var gridID = '<%= organizationListGridView.ClientID %>';
